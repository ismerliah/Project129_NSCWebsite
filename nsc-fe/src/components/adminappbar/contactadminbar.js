          ...
          <Toolbar disableGutters>
            ...
            <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
              ...
              >
                  ...
                  <MenuItem onClick={handleCloseNavMenu}>
                    <Button textAlign="center" href='http://localhost:3000/admincontact' sx={{ color: '#004aad', fontFamily: 'Noto Sans Thai', fontSize: 17}}>{pages[2]}</Button>
                  </MenuItem>
              </Menu>
            </Box>
            <Typography
...
export default ContactAdminBar;
