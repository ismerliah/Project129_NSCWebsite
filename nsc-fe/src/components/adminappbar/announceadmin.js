          ...
          <Toolbar disableGutters>
            ...
            <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
              ...
              >
                  ...
                  <MenuItem onClick={handleCloseNavMenu}>
                    <Button textAlign="center" href='http://localhost:3000/admindetail' sx={{ color: 'black', fontFamily: 'Noto Sans Thai', fontSize: 17}}>{pages[1]}</Button>
                  </MenuItem>
                  <MenuItem onClick={handleCloseNavMenu}>
            ...
            <Box sx={{ flexGrow: 0 }}>
              ...
              >
                  <MenuItem onClick={handleCloseUserMenu}>
                    <Button href='http://localhost:3000/adminannounce' textAlign="center" sx={{ color: '#004aad', fontFamily: 'Noto Sans Thai', fontSize: 17}}>ประกาศ</Button>
                  </MenuItem>
                  <MenuItem onClick={handleCloseUserMenu}>
...
export default AnnounceadminBar;
