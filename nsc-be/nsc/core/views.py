...
from .models import Adminupload1, Adminupload2, Certificate, NewUser, NewUserdetail
from .serializers import CertificateSerializer, NewUserSerializer, Adminupload1Serializer, Adminupload2Serializer, NewUserdetailSerializer
...
class NewUserdetailViewset(viewsets.ModelViewSet) :
    ...
    queryset = NewUserdetail.objects.all()
