...
from .views import Adminupload1Viewset, Adminupload2Viewset, CertificateViewset, NewUserdetailViewset, whoami, NewUserViewset
...
router.register(r"userdetail", NewUserdetailViewset, basename='userdetail')
