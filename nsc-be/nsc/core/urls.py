...
from .views import Adminupload1Viewset, Adminupload2Viewset, CertificateViewset, UserdetailViewset, UserprojectdetailViewset, whoami, NewUserViewset
...
router.register(r"userdetail", UserprojectdetailViewset, basename='userdetail')
