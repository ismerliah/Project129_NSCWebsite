...
from .views import Adminupload1Viewset, Adminupload2Viewset, CertificateViewset, ProjectdeatilViewset, whoami, NewUserViewset
...
router.register(r"projectdetail", ProjectdeatilViewset, basename='projectdeatail')
